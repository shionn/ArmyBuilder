...
import armybuilder.v3.model.nighthaunt.NighthauntRule;
import armybuilder.v3.model.rule.IRule;
import armybuilder.v3.model.skaven.SkavenRule;
import armybuilder.v3.model.stormcast.StormcastRule;
...
//	CoS(null, null),
	...
	Skaven(Arrays.asList(SkavenRule.LUnionFaitLaForce),
			a -> {
				...
				// clan echin
				a.addIf(a.count(KeyWord.ClansEshin) > 0 && a.count(KeyWord.Heros, KeyWord.ClansEshin) < 3,

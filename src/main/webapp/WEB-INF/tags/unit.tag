...
<%@ tag import="armybuilder.model.unit.Unit" %>
<%@ tag import="armybuilder.model.army.Army" %>
<%@ tag import="armybuilder.model.army.SubAllegiance" %>
<%@ tag import="armybuilder.model.army.Allegiance" %>
<%@ tag import="armybuilder.model.army.PackDeBataille" %>
<%@ tag import="armybuilder.model.army.AptitudeDeCommandement" %>
<%@ tag import="armybuilder.model.army.GrandeStrategie" %>
<%@ tag import="armybuilder.model.army.Triomphes" %>
<%@ tag import="armybuilder.model.army.bataillon.BataillonType" %>
<%@ tag import="armybuilder.model.rule.RuleType" %>
<%@ tag import="armybuilder.model.rule.RuleIcons" %>
<%@ tag import="armybuilder.model.unit.model.UnitModel" %>
<%@ tag import="armybuilder.model.unit.role.RoleTactique" %>

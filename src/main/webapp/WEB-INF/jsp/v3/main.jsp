...
<%@ page import="armybuilder.v3.model.army.SubAllegiance" %>
<%@ page import="armybuilder.v3.model.army.Allegiance" %>
<%@ page import="armybuilder.v3.model.army.PackDeBataille" %>
<%@ page import="armybuilder.v3.model.army.AptitudeDeCommandement" %>
<%@ page import="armybuilder.v3.model.army.GrandeStrategie" %>
<%@ page import="armybuilder.v3.model.army.Triomphes" %>
<%@ page import="armybuilder.v3.model.army.UnitGroupDisplay" %>
<%@ page import="armybuilder.v3.model.army.bataillon.BataillonType" %>
<%@ page import="armybuilder.v3.model.rule.RuleType" %>
<%@ page import="armybuilder.v3.model.rule.RuleIcons" %>
<%@ page import="armybuilder.v3.model.unit.model.UnitModel" %>
<%@ page import="armybuilder.v3.model.unit.role.RoleTactique" %>
<%@ page import="armybuilder.v3.model.rule.desc.DescriptionMode" %>
...
<spring:url value="/v3/army/edit" var="url" />
...
<div style="display: flex">
	<spring:url value="/v3/unit/add" var="url" />
	...
	<spring:url value="/v3/bataillon/add" var="url" />
	<form:form action="${url}" method="POST" style="width: 50%">
		<fieldset>
...
<div style="page-break-inside: avoid;">
	...
	<c:forEach items="${army.bataillons}" var="bat">
		<article class="bataillon">
			<spring:url value="/v3/bataillon/rm/${bat.id}" var="url" />
